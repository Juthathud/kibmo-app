...
const CATEGORIES = [
  { label: "รับจ้างจองคิว", subs: ["จองคิวร้านอาหาร/สถานบันเทิง", "จองคิวซื้อของ/รับหิ้ว"] },
  { label: "งานคลังสินค้า", subs: [] },
  { label: "งานขาย", subs: [] },
  { label: "งานอีเวนต์", subs: [] },
  { label: "งานจัดเรียง/เติม/ตรวจสอบสินค้า", subs: [] },
  { label: "งานร้านอาหาร/คาเฟ่", subs: ["พนักงานเสิร์ฟ/บริการ", "พนักงานครัว", "ชง/ขายเครื่องดื่ม", "พนักงานล้างจาน"] },
  { label: "งานบริการ", subs: [] },
  { label: "งานธุรการ/เลขานุการ", subs: ["งานคีย์/ตรวจสอบข้อมูล"] },
  { label: "อื่นๆ", subs: [] },
];
